...
def cout2bis(x,y,k,l,gap = 1,dif = 1):
    #on recree les 2 tableaux a partir de la case i,j
    m,n = len(x), len(y)-l
    F1 = np.zeros(n+1, dtype=int)  # ligne i-1
    F2 = np.zeros(n+1, dtype=int)  # ligne i
    v1 = 1
...
if __name__ == "__main__":
    ...
    print("----------------------------")
    print("1 - Visualisation courte sequence")
    print("2 - Choix longueur sequence")
    print("")
    choix = input("Choix : ")

    if (choix == '1'):
        print("----------------------------")
        print("1 - Inst_0000010_44.adn")
        print("2 - Inst_0000100_3.adn")
        choix2 = input("Sequence : ")
        if (choix2== '1'):
        ...
        L = lire_sequence("Inst_0001000_2.adn")
        #L = lire_sequence("Inst_0003000_25.adn")
        #L = lire_sequence("Inst_0005000_32.adn")
        #L = lire_sequence("Inst_0008000_32.adn")
        #L = lire_sequence("Inst_0010000_7.adn")
        #L = lire_sequence("Inst_0012000_10.adn")
        #L = lire_sequence("Inst_0015000_30.adn")
        #L = lire_sequence("Inst_0020000_64.adn")
        #L = lire_sequence("Inst_0050000_88.adn")
        #L = lire_sequence("Inst_0100000_11.adn")
    ...
    print("----------------------------")
    print("COUT_GAP = ", COUT_GAP, "COUT_DIFFERENCE = ", COUT_DIF)
    ...
    print("Cout de l'alignement : ", coutAlign(c1,c2,COUT_GAP,COUT_DIF))
